...
<!-- Basic datatable -->
<form method="POST" action="{{ route('data.nomor.save_upload', Request::segment(2)) }}" enctype="multipart/form-data">
	@csrf
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h6 class="panel-title">Import Data Kotak Pegawai</h6>
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<input type="file" name="filenomor" value="{{ old('filenomor') }}" required class="form-control" placeholder="">
			</div>

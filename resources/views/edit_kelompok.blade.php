...
<!-- Basic datatable -->
<form method="POST" action="{{ route('data.kelompok.update') }}">
	@csrf
	<div class="panel panel-flat">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<input type="text" name="nama_kelompok" value="{{ old('nama_kelompok') ?: $data->nama_kelompok }}" required class="form-control" placeholder="Nama Kelompok">
			</div>
			
			<div class="form-group">
				<label>Deskripsi Kelompok:</label>
				<textarea rows="5" cols="5" class="form-control" placeholder="Masukkan deskripsi" name="deskripsi">{{ old('deskripsi') ?: $data->deskripsi }}</textarea>
			</div>
